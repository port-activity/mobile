...
# Build Android
echo ">>> Building android production-release for Gävle"
expo ba --config ./app.gavle.json --release-channel prod-gavle --type app-bundle --keystore-path $KEYSTORE_PATH --keystore-alias $KEYSTORE_ALIAS
